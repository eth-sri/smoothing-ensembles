'''
- this file is necessary to load the datasets (CIFAR10 and ImageNet)
- it is based on the publicly available code https://github.com/locuslab/smoothing/blob/master/code/datasets.py written by Jeremy Cohen and https://github.com/Hadisalman/smoothing-adversarial/blob/master/code/datasets.py written by Hadi Salman
'''
...
# added for some SmoothAdv models 
